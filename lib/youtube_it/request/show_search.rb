class YouTubeIt
  module Request #:nodoc:
    class ShowSearch < BaseSearch #:nodoc:
      include FieldSearch
      ...
      def initialize(params={})
		...
		if params[:showid]
			@url << "shows/" + params[:showid] + "/content"
			params.delete(:max_results)
			params.delete(:offset)
		elsif params[:seasonid]
			@url << "seasons/" + params[:seasonid] + "/episodes"
			params.delete(:max_results)
			params.delete(:offset)
		elsif params[:type] == 'most_popular'
			@url << "charts/shows/most_popular"
		elsif params[:type] == 'most_recent'
			@url << "charts/shows/most_recent"
		else
			@url << "charts/shows/most_popular"
		end
